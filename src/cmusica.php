...
$connect = mysqli_connect("localhost","root","","musicworld");
    $query = "SELECT * FROM `albums` order by nome";
...
<!--Formulario-->
<div class="form">
<br><h1>Cadastre Uma Música</h1>
<form action="salvarm.php">
Música:<br>
<input type="text" name="nome" class="form-field">
<br>
<br>Do Album (deve ser cadastrado anteriormente):<br>
<select name="album" class="form-field">
<?php while($row2 = mysqli_fetch_array($result)):;
$sql = "SELECT * FROM `bandas` where id='$row2[2]'";
$result1 = mysqli_query($connect, $sql);
$row = mysqli_fetch_array($result1)
?>
<option value="<?php echo $row2[0];?>"><?php echo $row2[1];?> - <?php echo $row[1];?></option>
<?php endwhile;?>
</select><br>
