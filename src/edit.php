...
<h1>Alterar Banda</h1><br><br>
<?php
         if($total){do{
         ?>
        <div class="divbanda link"><br><h1><?php echo $linha['nome']?></a>&nbsp&nbsp
        <a href="<?php echo "novobanda.php?id=".$linha['id'] . "&nome=" . $linha['nome'] . "&estilo=" . $linha['estilo'] . "&pais=" . $linha['pais']?>" class="link"><img src="img/icones/editar.png" style="height:30px;"></a>&nbsp&nbsp
        <a href="<?php echo "excluirb.php?id=".$linha['id']?>" class="link"><img src="img/icones/excluir.png" style="height:30px;"></a>
        </div><br>
         <?php 
