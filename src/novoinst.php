...
<!--Formulario-->
<div class="form">
<br><h1>Edite o instrumento</h1>
<form action="alterari.php">
<input type="hidden" name="id" class="form-field" value="<?php echo $id?>">
Nome:<br>
<input type="text" name="nome" class="form-field" value="<?php echo $nome?>">
<br>
  <input type="submit" value="Alterar" class="submit-button">
<br><br>
</form>
</div>
<br>