...
session_start();
    ...
    $dados=mysqli_query($mysqllink,"select * from pessoas order by nome");
...
<h1>Alterar Músico</h1><br><br>
<?php
         if($total){do{
         ?>
        <div class="divbanda link"><br><h1><?php echo $linha['nome']?></a>&nbsp&nbsp
        <a href="<?php echo "novomus.php?id=".$linha['id'] . "&nome=" . $linha['nome']?>" class="link"><img src="img/icones/editar.png" style="height:30px;"></a>&nbsp&nbsp
        <a href="<?php echo "excluirmus.php?id=".$linha['id']?>" class="link"><img src="img/icones/excluir.png" style="height:30px;"></a>
        </div><br>
         <?php 
