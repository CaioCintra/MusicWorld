...
$query = "SELECT * FROM `instrumentos` order by nome";
    $result = mysqli_query($connect, $query);
    $connect1 = mysqli_connect("localhost","root","","musicworld");
...
<!--Formulario-->
<div class="form">
<br><h1>Remover Instrumento Para Músico</h1>
<form action="ntocamais.php">
Instrumento:<br>
<select name="inst" class="form-field">
<?php while($row = mysqli_fetch_array($result)):;?>
<option value="<?php echo $row[0];?>"><?php echo $row[1];?></option>
<?php endwhile;?>
</select>
<br>Músico:<br>
<select name="mus" class="form-field">
