...
$connect = mysqli_connect("localhost","root","","musicworld");
    $query = "SELECT * FROM `bandas` order by nome";
...
<!--Formulario-->
<div class="form">
<br><h1>Recomende uma banda</h1>
<form action="salvarr.php">
Banda que receberá a recomendação:<br>
<select name="rec" class="form-field">
<?php while($row = mysqli_fetch_array($result)):;?>
<option value="<?php echo $row[0];?>"><?php echo $row[1];?></option>
<?php endwhile;?>
</select>
<br>Banda recomendada:<br>
<select name="rec1" class="form-field">
