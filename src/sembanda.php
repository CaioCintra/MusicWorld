...
$query = "SELECT * FROM `integrantes` order by pessoa";
...
<!--Formulario-->
<div class="form">
<br><h1>Adicionar Integrante para Banda</h1>
<form action="salvarsembanda.php">
Integrante/banda:<br><br>
<select name="id" class="form-field">
<?php while($row = mysqli_fetch_array($result)):;
$sql = "SELECT * FROM `pessoas` where id='$row[1]'";
$result1 = mysqli_query($connect, $sql);
$row2 = mysqli_fetch_array($result1);
$sql1 = "SELECT * FROM `bandas` where id='$row[2]'";
$result2 = mysqli_query($connect, $sql1);
$row3 = mysqli_fetch_array($result2)
?>
<option value="<?php echo $row[0];?>"><?php echo $row2[1];?> - <?php echo $row3[1];?></option>
<?php endwhile;?>

</select>
<br>
  <input type="submit" value="Remover" class="submit-button">
<br><br>
</form>
</div>
<br>